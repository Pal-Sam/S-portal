...
$sql="Select * from details where usn='$usid' AND password='$pass'";
...
if($num==1){
  ...
  header("location:/student/main/home.php");
}
else{
...
<div class="form-div">
  ...
  <form class="login" name="myform" action="/student/login/login.php"  method="post" onsubmit=" return validateLoginForm()"  >
